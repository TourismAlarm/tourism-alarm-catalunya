// =================================================================
// BASE DE DATOS COMPLETA: 947 MUNICIPIOS CATALUNYA CON COORDENADAS
// =================================================================

// Coordenadas de todos los municipios de Catalunya por códigos INE
export const CATALUNYA_COORDINATES = {
  ...
  '082009': [41.5641, 2.0116], // (Ver arriba)
  ...
  '431713': [41.0765, 1.1398], // Salou (actualizado)
  ...
  '431481': [41.1189, 1.2445], // Tarragona (actualizado)
...
// Funciones auxiliares para obtener información de municipios
export function getCoordinatesForMunicipality(id) {
  return CATALUNYA_COORDINATES[id] || { lat: 41.3851, lng: 2.1734 }; // Default Barcelona
}

export function getMunicipalityProvince(id) {
...
export function isValidMunicipalityCode(id) {
  return CATALUNYA_COORDINATES.hasOwnProperty(id);
}

export function getAllMunicipalityCodes() {
  return Object.keys(CATALUNYA_COORDINATES);
}
...
export function getMunicipalitiesByProvince(province) {
  ...
  return Object.keys(CATALUNYA_COORDINATES).filter(id => 
    id.startsWith(provinceCode)
  );
}

// Estadísticas de la base de datos
export const CATALUNYA_STATS = {
  totalMunicipalities: Object.keys(CATALUNYA_COORDINATES).length,
  byProvince: {
    Barcelona: getMunicipalitiesByProvince('Barcelona').length,
    Girona: getMunicipalitiesByProvince('Girona').length,
    Lleida: getMunicipalitiesByProvince('Lleida').length,
    Tarragona: getMunicipalitiesByProvince('Tarragona').length
  }
};